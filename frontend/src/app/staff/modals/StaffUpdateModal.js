...
const StaffUpdateModal = ({ staffId, onClose, onSuccess }) => {
    ...
    const validate = () => {
        ...
        if (originalData) {
            ...
            if (!isChanged) {
                return { msg: 'Bạn chưa chỉnh sửa thông tin nào!', type: 'warning' };
            }
        }
    ...
    const handleSubmit = async (e) => {
        ...
        if (validationError) {
            ...
            return setErrorMsg(validationError.msg);
        }
        setSaving(true);
        setErrorMsg('');
        try {
            ...
            const errMsg = res.message ?? res.data?.message ?? 'Cập nhật thất bại!';
            setErrorType('danger');
            setErrorMsg(errMsg);
    ...
    return (
        <BaseModal onClose={onClose} maxWidth="900px" disableClose={saving}>
            <div style={{
                background: '#fff', borderRadius: '20px',
                overflow: 'hidden', boxShadow: '0 25px 60px rgba(0,0,0,0.15)'
            }}>
                <div style={{
                        ...
                        <div className="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h5 className="fw-bold m-0">
                                    <i className="bi bi-pencil-square me-2" />Chỉnh Sửa Nhân Viên
                                </h5>
                ...
                {errorMsg && (
                    <div style={{ padding: '16px 32px 0 32px' }}>
                        <AlertMessage type={errorType} message={errorMsg} />
                    </div>
                )}
                        ...
                        <div className="row g-4">
                            ...
                            <div className="col-md-6">
                                <div style={sectionStyle}>
                                    ...
                                    <div className="mb-3">
                                        <label className="small fw-bold text-secondary">Email (Tài khoản)</label>
                                        <input type="email" className="form-control bg-light"
                                            value={formData.email} disabled />
                                        <small className="text-muted">
                                            <i className="bi bi-lock-fill me-1" />Không thể thay đổi email đăng nhập
                                        </small>
                                    </div>
                                    <div className="mb-3">
                                        ...
                                        <input type="text" name="phoneNumber" className="form-control"
                                            value={formData.phoneNumber} maxLength={11}
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-6 mb-3">
                                            ...
                                            <select name="isActive" className="form-select"
                                                value={formData.isActive} onChange={handleChange}>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-6 mb-3">
                                            ...
                                            <input type="number" name="baseSalary" className="form-control"
                                                value={formData.baseSalary} min="0" max="100000000"
                                                onChange={handleChange} />
                                        </div>
                                    </div>
                                    <div style={{
                                        background: '#fff', borderRadius: '10px',
                                        padding: '14px', border: '1px dashed #fca5a5'
                                    }}>
