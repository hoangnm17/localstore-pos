                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="position-relative mb-3">
                                        <input
                                            ...
                                            style={{ fontSize: '1.2rem', padding: '12px', background: '#f8f9fa', paddingRight: '45px' }}
                                            required minLength="6"
                                        />
                                        <i
                                            className={`bi ${showPass ? 'bi-eye-slash-fill' : 'bi-eye-fill'} position-absolute`}
                                            style={{ right: '15px', top: '50%', transform: 'translateY(-50%)', cursor: 'pointer', fontSize: '1.2rem', color: '#6c757d' }}
                                    ...
                                    <div className="position-relative mb-4">
                                        ...
                                        />
                                        <i
                                            className={`bi ${showConfirmPass ? 'bi-eye-slash-fill' : 'bi-eye-fill'} position-absolute`}
                                            style={{ right: '15px', top: '50%', transform: 'translateY(-50%)', cursor: 'pointer', fontSize: '1.2rem', color: '#6c757d' }}
